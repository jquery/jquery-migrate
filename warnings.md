...
### JQCOMPAT: AJAX events should be attached to document
...
### JQCOMPAT: Global events are undocumented and deprecated
...
**Solution:** Change the program to avoid the use of global events. The jQuery Compat plugin warns about this case but does _not_ restore the previous behavior since it was undocumented. 
