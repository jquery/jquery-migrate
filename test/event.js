...
test( ".live()/.die()", function() {
	...
	jQuery( "#foo" ).live( "click", true,
		function( e ) { equal( e.data, true, "live with event data" ); } );
	...
	equal( jQuery( "#nothiddendiv span" ).length, 0,
...
test( "toggle(Function, Function, ...)", function() {
	...
	expectWarning( "jQuery.fn.toggle", function() {
		link.click( preventDefault ).click().toggle( fn1, fn2 )
	...
	expectWarning( "'hover' event", function() {
		...
		jQuery( "#firstp" )
			...
			.bind( "click.hover.me.not", function( e ) {
				equal( e.handleObj.namespace,
					"hover.me.not", "hover hack doesn't mangle namespaces" );
			} )
